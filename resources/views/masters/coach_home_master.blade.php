...
<nav class="navbar navbar-inverse navbar-fixed-top" id="cNavBar" role="navigation" style="background: #888888; border-color:#888888">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" id="cGympal" href="{{ route('home') }}">
                <img width="40px" height="40px" style="position:relative; top:-10px" src="/front/storage/app/profileImg/logo_0607.png"/>
            </a>
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li>
                    <a id="cStuReg" href="{{ route('mycase') }}">我的個案</a>
                </li>

                <li>
                    <a id="cCoaReg" href="{{ route('myprofile') }}">我的資料</a>
                </li>


                <li>
                    <a id="cUserLogin" href="{{route('logout')}}">登出</a>
                </li>
            </ul>
        </div>
        <!-- /.navbar-collapse -->
...
{{--<ul class="nav navbar-nav navbar-default" style="display:inline-block;float: none;vertical-align:top;">--}}
{{--<li>--}}
{{--<a id="navBar" href="{{ route('home') }}">首頁</a>--}}
{{--</li>--}}
{{--<li>--}}
{{--<a id="navBar" href="{{ route('public_list_case') }}"> <img width="140px" min-height="100px" src="http://gympal.com.hk/front/storage/app/upload/Image/tStudentCase.jpg"/></a>--}}
{{--</li>--}}

{{--<li>--}}
{{--<a id="navBar" href="{{ route('public_list_coach') }}"><img width="140px" min-height="100px" src="http://gympal.com.hk/front/storage/app/upload/Image/tCoachDataBase.jpg"/></a>--}}
{{--</li>--}}
{{--<li>--}}
{{--<a id="navBar" href="{{route('view_static','find_coach')}}"><img width="140px" min-height="100px" src="http://gympal.com.hk/front/storage/app/upload/Image/tFindCoachFlow.jpg"/></a>--}}
{{--</li>--}}
{{--<li>--}}
{{--<a id="navBar" href="{{route('view_static','real_case')}}"><img width="140px" min-height="100px" src="http://gympal.com.hk/front/storage/app/upload/Image/tRealCase.jpg"/></a>--}}
{{--</li>--}}
{{--<li>--}}
{{--<a id="navBar" href="{{route('view_static','latest_news')}}"><img width="140px" min-height="100px" src="http://gympal.com.hk/front/storage/app/upload/Image/tLatestCase.jpg"/></a>--}}
{{--</li>--}}
{{--<li>--}}
{{--<a id="navBar" href="{{route('view_static','common_question')}}"><img width="140px" min-height="100px" src="http://gympal.com.hk/front/storage/app/upload/Image/tStudentFAQ.jpg"/></a>--}}
{{--</li>--}}
{{--<li>--}}
{{--<a id="navBar" href="{{route('view_static','about_us')}}"><img width="140px" min-height="100px" src="http://gympal.com.hk/front/storage/app/upload/Image/tContactUs.jpg"/></a>--}}
{{--</li>--}}
{{--</ul>--}}
{{--</div>--}}
...
<footer>
    ...
    {{--<a href="#" ><img style="margin-bottom: 5%" border="0" src="http://gympal.com.hk/front/storage/app/upload/Image/facebook.png" width="45" height="45"></a></a>--}}
    {{--<a href="#" ><img style="margin-bottom: 5%" border="0" src="http://gympal.com.hk/front/storage/app/upload/Image/instagram.png" width="42" height="42"></a>--}}
    {{--<a href="#" ><img style="margin-bottom: 5%" border="0" src="http://gympal.com.hk/front/storage/app/upload/Image/youtube.png" width="42" height="42"></a>--}}
    {{--<a href="#" ><img style="margin-bottom: 5%" border="0" src="http://gympal.com.hk/front/storage/app/upload/Image/email.png" width="42" height="42"></a>--}}
    {{--<a href="#" ><img style="margin-bottom: 5%" border="0" src="http://gympal.com.hk/front/storage/app/upload/Image/whatsapp.png" width="42" height="42"></a>--}}
    {{--<a href="#" ><img style="margin-bottom: 5%" border="0" src="http://gympal.com.hk/front/storage/app/upload/Image/phone.png" width="42" height="42"></a>--}}
    {{--</div>--}}
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <a href="https://www.facebook.com/gympalhk/"><img style="margin-bottom: 5%; padding-left: -5%;" border="0"
                                             src="http://gympal.com.hk/front/storage/app/upload/Image/facebook.png"
                                             width="55"
                                             height="55"></a></a>
                            <a href="https://www.instagram.com/gympalhk/" style="padding-left: 1%;"><img style="margin-bottom: 5%;" border="0"
                                                                       src="http://gympal.com.hk/front/storage/app/upload/Image/instagram.png"
                                                                       width="55"
                                                                       height="55"></a>
                            <a href="https://www.youtube.com/channel/UCmE7_OT8BkXinsdZJ4Z5iZw" style="padding-left: 1%;"><img style="margin-bottom: 5%;" border="0"
                                                                       src="http://gympal.com.hk/front/storage/app/upload/Image/youtube.png"
                                                                       width="55"
                                                                       height="55"></a>
                            <a href="{{route('view_static','contact_us')}}" style="padding-left: 1%;"><img style="margin-bottom: 5%;" border="0"
                                                                       src="http://gympal.com.hk/front/storage/app/upload/Image/email.png"
                                                                       width="55"
                                                                       height="55"></a>
                            <a href="{{route('view_static','contact_us')}}" style="padding-left: 1%;"><img style="margin-bottom: 5%;" border="0"
                                                                       src="http://gympal.com.hk/front/storage/app/upload/Image/whatsapp.png"
                                                                       width="55"
                                                                       height="55"></a>
                            <a href="{{route('view_static','contact_us')}}" style="padding-left: 1%;"><img style="margin-bottom: 5%;" border="0"
                                                                       src="http://gympal.com.hk/front/storage/app/upload/Image/phone.png"
                                                                       width="55"
                                                                       height="55"></a>
                        </div>
                    </div>
