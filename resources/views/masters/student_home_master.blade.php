        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a id="cStuReg" href="{{ route('create_case') }}">申請個案</a>
                    </li>
                    <li>
        ...
        @if($actionName=="home")
            ...
            <div id="wrapper">
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12" data-interval="15000">
        ...
        <!--
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-12">
                            <a href="#"><img style="margin-bottom: 5%; padding-left: -5%;" border="0"
                                             src="http://gympal.com.hk/front/storage/app/upload/Image/facebook.png"
                                             width="55"
                                             height="55"></a></a>
                            <a href="#" style="padding-left: 1%;"><img style="margin-bottom: 5%;" border="0"
