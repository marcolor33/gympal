...
<div class="row">
    <h1>{!! $category->name_chin !!}</h1>
    
    @foreach ($coachs as $coach)

@php 

$temp = explode(",",$coach->subject_id);
...
@if ($print)
<div>
    <a href="{{route('student_view_coach',$coach->account_id)}}"><img  src="{{route('view_image')}}?path={{$coach->profile_pic}}"/></a>
    ...
    <a class="btn btn-default" href="{{route('student_view_coach',$coach->account_id)}}">view</a>
