    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('coach_list_case') }}">尋找新個案</a></li>
                        ...
                        <div class="col-lg-12">
                            <form action="{{route('show_interest',$case->case_id)}}" id = "showInterestForm" role="form">
                                <div class="form-group">
                                    your information<input class ="must form-control" type="text" id="information" name = "information"/>
                                </div>
                                <div class="form-group">
...
//                       
    ...
    function reset_showInterestForm()
    {
        ...
        @if ($interest)
            $("[name='information']").val('{!! $interest->information !!}');
        @endif
    }
