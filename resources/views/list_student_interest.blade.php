				...
				<div class="panel-body">
					<table id="mytable" width="100%" class="table table-striped table-bordered table-hover">
						...
						@foreach ($interests as $interest)
                            ...
                            <tr>
                                <td>{!! explode(" ",$interest->time_created)[0] !!}</td>
                                ...
                                <td><a href="{!! route('view_coach',$interest->coach_id) !!}">{!! $interest->coach_chin_name !!}</a></td>
                                <td><a href="{!! route('view_coach',$interest->coach_id) !!}">{!! $interest->coach_eng_name !!}</a></td>
                                <td>{!! $interest->coach_sex !!}</td>
                                <td>{!! $interest->status !!}</td>
                                <td><a class="btn btn-primary "onclick="change_status({!! $interest->student_id !!},{!! $interest->coach_id !!},'{!! $interest->status !!}');">set seen/new</a>  
                                <a class="btn btn-danger"onclick="delete_interest({!! $interest->student_id !!},{!! $interest->coach_id !!});">delete</a></td></tr>
