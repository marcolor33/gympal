...
<div class="container">
            ...
            <tr>
                <td align="center" width="50" >
                    <a href="{{ route('public_list_case') }}?category_id=3" >
                        <img src="images/fitness.jpg" width="200" height="140"></a>
                </td>
                <td align="center" width="50">
                    <a href="{{ route('public_list_case') }}?category_id=3" >
                        <img src="images/yoga.jpg" width="200" height="140"></a>
                </td>
                <td align="center" width="50">
                    <a href="{{ route('public_list_case') }}?category_id=3" >
                        <img src="images/swim.jpg" width="200" height="140">
                    </a>
                </td>
                <td align="center" width="50">
                    <a href="{{ route('public_list_case') }}?category_id=3" >
                        <img src="images/ball.jpg" width="200" height="140"></a>
                </td>
            </tr>
        ...
        {{--<div class="col-lg-12">--}}
            ...
            @foreach ($coachs as $coach)
                        <div class="col-md-6 img-portfolio">
                            <a href="{{route('public_view_coach',$coach->account_id)}}"><img width="100" class="img-responsive img-hover" src="http://piq.codeus.net/static/media/userpics/piq_157628_400x400.png"/></a>
    ...
    <a class="btn btn-default" href="{{route('public_view_coach',$coach->account_id)}}">詳細</a>
