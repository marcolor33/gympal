...
Route::get('/success',['uses'=>'AdminController@success','as'=>'success']);
Route::get('/payment',['uses'=>'AdminController@payment','as'=>'payment']);
Route::get('/test_page',['uses'=>'AdminController@test_page','as'=>'test_page']);
...
Route::post('/delete_static/{name}',['uses' => 'AdminController@delete_static','as'=>'delete_static']);
...
Route::post('/delete_interest',['uses'=>'AdminController@delete_interest','as'=>'delete_interest']);
